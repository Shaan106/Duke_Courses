...
% k calculated as 60 / bpm. This represents the duration of one beat in seconds.
k = 60 / bpm;
...
lengthDifference = length(song_halfNotes) - length(song_wholeNotes);

% Check if padding is needed
if lengthDifference > 0
    % Pad song_wholeNotes with zeros at the end
    song_wholeNotes = [song_wholeNotes, zeros(1, lengthDifference)];
end

% Now song_wholeNotes and song_halfNotes are of the same length and can be added
